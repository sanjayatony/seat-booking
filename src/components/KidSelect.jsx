  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <div className="bg-indigo-600 px-4 pb-16 pt-10 text-center text-white">
        ...
        <p className="mt-1 text-sm text-indigo-200">{email}</p>
      </div>
          ...
          <div ref={ref} className="relative">
            <div className="relative">
              ...
              <input
                ...
                className="block w-full rounded-xl border border-gray-200 bg-gray-50 py-3 pl-10 pr-4 text-sm placeholder:text-gray-400 focus:border-indigo-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-100"
              />
            </div>
                ...
                {filtered.map((name, i) => (
                  <li
                    ...
                    className={`flex cursor-pointer items-center gap-3 px-4 py-2.5 text-sm transition-colors
                      ${i === highlightedIndex ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700 hover:bg-gray-50'}`}
                  >
